...
// 
//
// Related Topics 数组 交互 模拟 👍 61 👎 0

package leetcode.editor.cn;
//java:用 Read4 读取 N 个字符
class P157ReadNCharactersGivenRead4{
    public static void main(String[] args){
        Solution solution = new P157ReadNCharactersGivenRead4().new Solution();
    }
...
public class Solution extends Reader4 {
    ...
    public int read(char[] buf, int n) {
        ...
        while (readn < n) {
            ...
            if (x >= 0) System.arraycopy(buf4, 0, buf, readn, x);
            readn += x; // 记录目前读到多少个字符
        }
        return Math.min(readn, n);
    }
}

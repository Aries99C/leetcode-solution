...
//
// Related Topics 哈希表 链表 双指针 👍 2287 👎 0
...
public class Solution {
    public ListNode getIntersectionNode(ListNode headA, ListNode headB) {
        ...
        while (nodeA != nodeB) {
            // skipA == skipB的情况下，不需要交替前进也能在交点相遇
            // skipA != skipB的情况下，一定交替前进并且在均为null前在交点相遇
            if (nodeA == null) {
                nodeA = headB;
            } else {
                nodeA = nodeA.next;
        ...
        if (nodeA == null) { // 两个指针都在链表末尾的null相交，说明不相交
            return null;
        }
